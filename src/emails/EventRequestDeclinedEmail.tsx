...
export default function EventRequestDeclinedEmail(props: Props) {
  const m = getMessages(props.locale, "emails").eventDeclined;

  const reasonMap: Record<string, string> = {
    no_availability: m.reasonNoAvailability,
    out_of_capacity: m.reasonOutOfCapacity,
    budget_mismatch: m.reasonBudgetMismatch,
    other: m.reasonOther,
  };
  const reasonCopy = reasonMap[props.declineReason] ?? props.declineReason;
