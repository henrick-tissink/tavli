...
export const JOBS = {
  ...
  marketing: {
    ...
    fireTriggeredCampaign: "marketing.fire-triggered-campaign",
    refreshSegmentSize: "marketing.refresh-segment-size",
    usageAlert: "marketing.usage-alert",
    computeAttribution: "marketing.compute-attribution",
    monthlyOverageBilling: "marketing.monthly-overage-billing",
    processResendWebhook: "marketing.process-resend-webhook",
    processTwilioWebhook: "marketing.process-twilio-webhook",
    purgeOldLinkClicks: "marketing.purge-old-link-clicks",
  },
  billing: {
  ...
  diner: {
    ...
    birthdayScan: "diner.birthday-scan",
